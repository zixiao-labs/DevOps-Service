  ...
  return (
    <Box>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, maxWidth: 640 }}>
        {/* General */}
        <Paper sx={{ p: 3 }}>
          <Typography variant="subtitle1" fontWeight={600} gutterBottom>基本信息</Typography>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 2 }}>
            <TextField label="组织名称" defaultValue="Zixiao Labs" size="small" fullWidth />
            <TextField label="描述" defaultValue="紫霄研究所 - 开发者工具与基础设施" size="small" fullWidth multiline rows={2} />
        ...
        {/* Features */}
        <Paper sx={{ p: 3 }}>
          <Typography variant="subtitle1" fontWeight={600} gutterBottom>功能开关</Typography>
          <Box sx={{ mt: 1 }}>
            <FormControlLabel
        ...
        <Paper sx={{ p: 3, borderColor: 'error.main', border: 1 }}>
          <Typography variant="subtitle1" fontWeight={600} color="error" gutterBottom>危险区域</Typography>
          <Divider sx={{ my: 1.5 }} />
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
            <Box>
              <Typography variant="body2" fontWeight={500}>转让组织</Typography>
          ...
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <Box>
              <Typography variant="body2" fontWeight={500}>删除组织</Typography>
